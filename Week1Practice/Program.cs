...
namespace Week1Practice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("My name, " + myName + ", has " +  myName.Length +" of letters in it");
            // 2. Print out the number of items in your list using the format: "My product list has <number of items> in it."

            Console.WriteLine("My product list has " + productsList.Count +" of items in it.");
        ...
        {
            Console.WriteLine("Im looping from " + startNum + " to " + endNum);
